...
export default function Dashboard() {
  const { user } = useAuth()
  // Mock data represents user processes
  const processes = Object.values(MOCK_PROCESSES)
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="flex-1 p-6 md:p-8">
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                      ...
                      <Badge
                        className={`${getStatusColor(process.status)} border-0 hover:${getStatusColor(process.status)} px-3 py-1`}
                      >
                  ...
                  <div className="bg-muted/30 p-6 md:p-8 flex flex-col justify-center items-center md:items-end border-t md:border-t-0 md:border-l md:w-72 shrink-0">
                    ...
                    <Link to={`/processo/${encodeURIComponent(process.number)}`} className="w-full">
